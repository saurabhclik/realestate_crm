...
<script>
    ...
    function updateDataStatus() 
    {
        ...
        if (isRejected) 
        {
            ...
            if (!comment) 
            {
                flasher.warning('Please enter a rejection remark or select a quick note');
                return;
            }
        } 
        else if (isFollowup) 
        {
            ...
            {
                flasher.warning('Please enter a note or select a date/time');
                return;
            }
        } 
