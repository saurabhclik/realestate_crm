...
<head>
    ...
    <style>
        ...
        .header 
        { 
            background-color: #3762b8; color: white; padding: 15px; text-align: center; border-radius: 8px 8px 0 0; 
        }
        .content 
        { 
            padding: 20px;
        ...
        .btn 
        { 
            display: inline-block; background-color: #3762b8; color: #fff !important; padding: 10px 15px; text-decoration: none; border-radius: 5px; margin-top: 15px; 
        }
        .alert 
        { 
