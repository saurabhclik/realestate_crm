            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <ul class="nav nav-tabs nav-tabs-custom mb-4" id="TaskTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" data-bs-target="#TodayTask"
                                style="cursor:pointer;">
                                Today
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#TomorrowTask"
                                style="cursor:pointer;">
                                Tomorrow
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" data-bs-target="#MissedTask"
                                style="cursor:pointer;">
                                Missed 7days
                            </a>
                        </li>
                    ...
                    <div class="tab-content" id="TaskTabContent">
                                            ...
                                            <tr class="task-row" data-task-id="{{ $task->id }}">
                                                        ...
                                                        <div class="flex-grow-1">
                                                            ...
                                                            <div class="collapse" id="taskDetails{{ $task->id }}">
                                                                <div class="card card-body bg-light p-3 mt-2 border-0">
                                                                    ...
                                                                    @php
                                                                        $allComments =
                                                                            $task_all_comments[$task->id] ?? collect();
                                                                        $lastComment = $allComments->isNotEmpty()
                                                                            ? $allComments->last()->comment
                                                                            : 'No comment found';
                                                ...
                                                <td>
                                                    @if ($task->project_name && $task->project_name !== 'No Project')
                                                        <span
                                                            class="badge bg-info-subtle text-info fw-semibold px-2 py-1"
                                                    ...
                                                    @else
                                                        <span
                                                            class="badge bg-secondary-subtle text-secondary fw-semibold px-2 py-1"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                ...
                                                <td>
                                                    <span
                                                        class="badge bg-{{ $task->priority == 'high' ? 'danger' : ($task->priority == 'medium' ? 'warning' : 'success') }} p-2 font-size-12">
                                                        <i class="fas fa-circle me-1 font-size-10"></i>
                                                ...
                                                <td>
                                                    @if ($task->status == 'completed')
                                                        <span
                                                            class="btn btn-sm btn-success w-100 text-start font-size-12">
                                                            <i class="fas fa-check-circle me-1"></i> Completed
                                                        </span>
                                                    @else
                                                        <div class="dropdown">
                                                            <button
                                                                class="btn btn-sm btn-{{ $task->status == 'in_progress' ? 'info' : 'secondary' }} dropdown-toggle w-100 text-start font-size-12"
                                                                type="button" data-bs-toggle="dropdown">
                                                                <i
                                                                    class="fas {{ $task->status == 'in_progress' ? 'fa-spinner' : 'fa-clock' }} me-1"></i>
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item status-option"
                                                                        data-status="in_progress">In Progress</a>
                                                                </li>
                                                                <li>
                                                                    <a class="dropdown-item status-option"
                                                ...
                                                <td>
                                                    ...
                                                    @foreach ($assignedMembers as $member)
                                                        <span
                                                            class="badge bg-light text-dark mb-1 font-size-12">{{ $member->name }}</span>
                                                    @endforeach
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        <a href="#"
                                                            class="btn btn-light btn-sm dropdown-toggle rounded-circle"
                                                            role="button" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            <i
                                                                class="fas fa-ellipsis-v {{ $task_owner === $task->user_id ? 'text-primary' : 'text-danger no-editDelete-right' }}"></i>
                                                        </a>
                                                        <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                                                            @if ($task_owner === $task->user_id)
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('task.create', ['id' => $task->id]) }}">
                                                                        <i
                                                                            class="fas fa-edit me-2 {{ $task_owner === $task->user_id ? 'text-primary' : 'text-danger no-editDelete-right' }}"></i>
                                                                        Edit
                                                                    </a>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item delete-task" href="#"
                                                                        data-id="{{ $task->id }}">
                                                                        <i
                                                                            class="fas fa-trash-alt me-2 text-danger"></i>
                                                                        Delete
                                                                    </a>
                                                                </li>
                                                            @endif
                                        ...
                                        @foreach ($events->where('timeframe', 'Tomorrow') as $task)
                                            <tr class="task-row" data-task-id="{{ $task->id }}">
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
                                                            <h6 class="mb-1 task-name fw-medium"
                        ...
                        {{-- -------------------- Missed Tasks -------------------- --}}
                        <div class="tab-pane fade" id="MissedTask" role="tabpanel">
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap mb-0" id="missed-task-table">
                                    <thead class="table-light">
                                        <tr>
                                            <th>Task</th>
                                            <th>Priority</th>
                                    ...
                                    <tbody>
                                        @foreach ($events->where('timeframe', 'Missed') as $task)
                                            <tr class="task-row" data-task-id="{{ $task->id }}">
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="flex-grow-1">
