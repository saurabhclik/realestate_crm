    ...
    <div class="dashboard">
        <header class="header">
            <div class="notification shadow">
                <span class="footer-nav-item notification-item position-absolute"
                    style="top:25px !important; right:127px !important; z-index:999999 !important; cursor: default;">
        ...
        <div class="stats-container">
            ...
            @else
                <!-- This shows when Lead Dashboard is active -->
                <div class="stat" id="statTotalLeads" role="region" aria-label="Total leads">
                    <a href="{{route('mobile.all-leads')}}">
                        <p>Total Leads</p>
                        <h3>{{ number_format($totalLeads ?? 0, 0) }}</h3>
                    </a>
                ...
                <!-- This is hidden by default, shows when MIS Dashboard is active -->
                <div class="stat" id="statPerformance" role="region" aria-label="MIS Performance" style="display:none;">
                    <a href="javascript:void(0)">
                        <p>Performance</p>
                        <h3>{{ number_format($misStats['overall_percentage'] ?? 0, 1) }}%</h3>
                    </a>
                </div>
                {{-- <div class="stat" role="region" aria-label="MIS Performance">
                    <a href="">
                        <p>Performance</p>
                        <h3>{{ number_format($misStats['overall_percentage'] ?? 0, 1) }}%</h3>
                    </a>
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary" id="SubmitBtn">
                    ...
                    <span id="SubmitSpinner" class="d-none">
                        <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span> Please
                        wait...
                    </span>
                </button>
            </div>
