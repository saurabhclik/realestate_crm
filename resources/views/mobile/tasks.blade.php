    ...
    <div class="filter-section">
        <div class="filter-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                <button class="select-all-btn" id="selectAllBtn" style="display: none; background: none; border: none; font-size: 1.2rem; color: #3762b8;">
                    <i class="fas fa-check-double"></i>
                </button>
                <button class="share-btn me-2 ms-4" id="shareBtn" style="display: none; background: none; border: none; font-size: 1.2rem; color: #3762b8;">
                    <i class="fas fa-share-alt"></i>
                </button>
                <button class="filter-toggle" id="filterToggle" style="background: none; border: none; font-size: 1.2rem; color: #3762b8;">
