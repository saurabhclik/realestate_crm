            ...
            <div class="tab-content" id="followupTabsContent">
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex gap-2 align-items-center">
                                            <a href="tel:{{ $item->phone }}" class="btn btn-xs btn-soft-light" title="Call">
                                                <i class="fas fa-phone text-primary">Lead Id</i>
                                            </a>
                ...
                <div class="tab-pane fade" id="missed" role="tabpanel">
                    <div class="table-responsive">
                        ...
                        <table id="missed-table" class="table-hover table-bordered dt-responsive nowrap w-100">
                            <thead class="table-light">
                                <tr>
                                    <th>#</th>
                                    <th>lead Id</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-3 align-items-center">
                                            ...
                                            {{-- Visited --}}
                                            @if($item->visited_on == 1)
                                            <span class="rounded-pill px-2 py-1 bg-light border text-success small">
                                                <i class="fas fa-user-check me-1"></i> Visited
                                            </span>
                                            @endif
                                    ...
                                    <td>
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex mt-1">
                                                ...
                                                <a href="tel:{{ $item->phone }}" class="btn btn-xs btn-soft-light">
                                                    <i class="fas fa-phone text-primary"></i>
                                                </a>

                                                <a href="https://wa.me/91{{ $item->phone }}" target="_blank" class="btn btn-xs btn-soft-light">
                                                    <i class="fab fa-whatsapp text-success"></i>
                                                </a>
                                                ...
                                                <a href="{{ route('lead.edit', $item->id) }}" class="btn btn-xs btn-soft-light">
                                                    <i class="fas fa-edit text-warning"></i>
                                                </a>
                                            ...
                                            {{-- Visited --}}
                                            @if($item->visited_on == 1)
                                            <span class="rounded-pill px-2 py-1 bg-light border text-success small mt-1">
                                                <i class="fas fa-user-check me-1"></i> Visited
                                            </span>
                                            @endif
