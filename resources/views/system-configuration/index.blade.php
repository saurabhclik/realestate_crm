    ...
    <div class="container-fluid">
        ...
        <div class="row g-3">
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm rounded-3 h-100 cursor-pointer"  onclick="window.location='{{ route('lead-status.index') }}'">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card border-0 shadow-sm rounded-3 h-100 cursor-pointer"  onclick="window.location='{{ route('setting.login_log') }}'">
                    <div class="card-body p-3 d-flex flex-column">
                        <div class="d-flex align-items-center gap-2 mb-2">
