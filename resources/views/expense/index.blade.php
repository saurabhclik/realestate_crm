                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ route('expense.index') }}" class="row g-3" id="filterForm">
                            ...
                            @if(in_array(Session::get('user_type'), ['admin', 'team_manager']))
                            <div class="col-md-4">
                            ...
                            <div class="table-responsive">
                                <table id="table" class="table table-hover table-bordered dt-responsive nowrap w-100">
                                    <thead class="table-light">
                                        <tr>
                                            @if(Session::get('user_type') == 'admin' && (!request('status') || request('status') == 'pending'))
                                            <th>
                                    ...
                                    <tbody>
                                        @foreach($expenses as $index => $expense)
                                            <tr>
                                                @if(Session::get('user_type') == 'admin' && (!request('status') || request('status') == 'pending'))
                                                <td>
                                                    @if(Session::get('user_type') == 'admin' && $expense->status == 'pending')
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td colspan="{{ (Session::get('user_type') == 'admin' && (!request('status') || request('status') == 'pending')) ? 4 : 3 }}"></td>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
