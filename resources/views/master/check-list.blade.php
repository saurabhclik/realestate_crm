...
'Product Category | Pro-leadexpertz' : 'Check List | Pro-leadexpertz')
@section('content')
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0">Check List<div class="border-bottom border-3 border-primary mb-2 mt-1 w-75"></div></h4>
