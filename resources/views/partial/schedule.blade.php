    ...
    <div class="card border-0 shadow-sm">
        ...
        <div class="card-body p-4">
            <ul class="nav nav-tabs nav-tabs-custom mb-4" id="followupTabs" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" data-bs-target="#next7days" style="cursor:pointer;">
                        Next 7 Days
                    </a>
                </li>
                <li class="nav-item">
                                        ...
                                        @foreach ($followups[$key] as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex gap-2 align-items-center">
                                                        <a href="tel:{{ $item->phone }}"
                                                            class="btn btn-xs btn-soft-light" title="Call">
                                                            <i class="fas fa-phone text-primary"></i>
                                                        </a>
                                                        <a href="https://wa.me/91{{ $item->whatsapp_no ?? $item->phone }}"
                                                ...
                                                <td>
                                                    @if ($type == 'Missed')
                                                        <span
                                                            class="badge bg-danger bg-opacity-10 text-danger">Scheduled</span>
                                                    @elseif($type == 'Call')
                                                        <span
                                                            class="badge bg-primary bg-opacity-10 text-light">Call</span>
                                                    @elseif($type == 'Visit')
                                                        <span
                                                            class="badge bg-success bg-opacity-10 text-success">Visit</span>
                                                    @elseif($type == 'Interested')
                                                        <span
                                                            class="badge bg-info bg-opacity-10 text-info">Interested</span>
                                                    @elseif($type == 'WhatsApp')
                                                        <span
                                                            class="badge bg-success bg-opacity-10 text-success">WhatsApp</span>
                                                    @else
                                                        <span
                                                            class="badge bg-secondary bg-opacity-10 text-muted">Scheduled</span>
                                                    @endif
                                                </td>

                                                <td>{{ $item->classification ?? '-' }}</td>
                                                <td>{{ \Carbon\Carbon::parse($item->remind_date)->format('d M Y') }}
                                                </td>
                ...
                <div class="tab-pane fade" id="next7days" role="tabpanel">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0" id="next7days-table">
                            ...
                            <tbody>
                                @foreach (['next7daysCalls', 'next7daysVisits', 'next7daysWhatsapp', 'next7daysMeetings', 'interestedNext7Days'] as $key)
                                    @if (isset($followups[$key]) && $followups[$key]->isNotEmpty())
                                        @foreach ($followups[$key] as $item)
                                            @php
                                                switch ($key) {
...
<script>
    $(document).ready(function() {
        ...
        $('a[data-bs-toggle="tab"]').on('shown.bs.tab', function(e) {
            ...
            if (target === '#next7days') next7daysTable.columns.adjust();
