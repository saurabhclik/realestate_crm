            ...
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center flex-wrap gap-2">
                        ...
                        <a href="{{ route('data-center.create') }}"
                            class="btn btn-primary btn-sm circle-btn"
                            title="Data Center">
                            <i class="fas fa-database"></i>
                        </a>
                                    ...
                                    <div class="row">
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <a href="{{ route('lead.all_lead', ['user' => $selectedAgent]) }}" class="text-decoration-none" style="cursor:pointer;">
                                                    <h5 class="font-size-15">{{ $leadStats->total_lead ?? 0 }}</h5>
                                                    <p class="text-muted mb-0">Total Leads</p>
                                                </a>
